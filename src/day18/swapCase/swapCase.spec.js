...
describe('swapCase()', () => {
  ...
  it('should return "are you serius?" when passed "ARE YOU SERIUS?"', () => {
    assert.equal(swapCase('ARE YOU SERIUS?'), 'are you serius?');
  });
  it('should return "bRO, lEbRON jAMES IS 33 YEARS OLD AND HE\'S STILL PLAYING LIKE WHEN HE WAS IN HIS PRIME, LOL!" when passed "Bro, LeBron James is 33 years old and he\'s still playing like when he was in his prime, lol!"', () => {
    assert.equal(
      swapCase(
